...
def infer(density_map_splits_dir, input_data_dir, density_map_name, atom_checkpoint, infer_run_on, infer_on_gpu):
    # 设置设备
    ...
    model, _ = load_checkpoint(model, atom_checkpoint, None)
    model.eval()
    ...
    with mrcfile.open(org_map, mode='r') as org_map_file:
        ...
        outfilename = f"{input_data_dir}/{density_map_name}/atom_predicted.mrc"
...
if __name__ == "__main__":
    ...
    infer(density_map_splits_dir, input_data_dir, density_map_name, atom_checkpoint, infer_run_on, infer_on_gpu)