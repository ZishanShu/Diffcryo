...
import time
import glob
from sampling import extract_seq_from_pdb
...
def main(coordinate_file, emission_file, config_dict, save_ca_probs):
    ...
    print("Coordinate list length:", length_coordinate_list)
    print("Coordinate distance matrix shape:", coordinate_distance_matrix.shape)
