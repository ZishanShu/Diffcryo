...
from sampling import get_probs_cords_from_atom_amino, clustering_centroid, grid_division
...
def make_predictions(config_dict):
    ...
    script_name = ['/gpfs/share/home/2201111701/szs/szs1/voxmol/infer/atom_inference.py', '/gpfs/share/home/2201111701/szs/szs1/voxmol/infer/amino_inference.py']
